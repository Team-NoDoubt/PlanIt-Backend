...
import com.nodoubt.planitbackend.global.error.response.BaseErrorResponse
...
class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PlanItException::class)
    fun handleCustomException(e: PlanItException): ResponseEntity<BaseErrorResponse> {
